...
import ProfileNavbar from '../../components/Signup/SignupNavbar';
    ...
    const handleSignup = async () => {
        ...
        try {
            const response = await fetch('http://localhost:5000/api/signup', {
                ...
                body: JSON.stringify({ username, email, password, name, address, contact, community }),
            });
            if (!response.ok) {
                ...
                <form onSubmit={(e) => {
                    ...
                    <div className="formContainer">
                        ...
                        <div className="rightInputs">
                            ...
                            <div className="inputBox">
                                <button className='map'> Locate on Map </button>
